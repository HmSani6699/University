      ...
      <div className="bg-[#f5f5f5] py-10 px-5 flex flex-col md:flex-row items-center  gap-8 max-w-6xl mx-auto my-[30px]">
        ...
        <div className="text-center md:text-left">
          ...
          <p>
            ...
            অর্জনের কেন্দ্র নয়, এটি নৈতিকতা, মূল্যবোধ ও মানবিক গুণাবলির বিকাশের
            ক্ষেত্রও বটে। আমাদের প্রতিষ্ঠানে আমরা প্রতিটি শিক্ষার্থীকে একজন
            আদর্শ নাগরিক হিসেবে গড়ে তোলার নিরন্তর প্রচেষ্টা চালিয়ে যাচ্ছি। আমি
            দৃঢ়ভাবে বিশ্বাস করি, সুশিক্ষার আলোয় আলোকিত হয়ে আমাদের শিক্ষার্থীরা
            আগামী দিনে সমাজ ও দেশের উন্নয়নে গুরুত্বপূর্ণ ভূমিকা রাখবে। ...
          </p>
